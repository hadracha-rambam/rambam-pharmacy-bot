...
# Placeholder for uploading documents (for future extension)
# uploaded_files = st.file_uploader("העלה קבצי PDF של פרוטוקולים", accept_multiple_files=True, type=["pdf"])
...
if vectorstore:
    ...
    st.warning("⚠️ טרם הועלו מסמכים או שהם לא נטענו כראוי.")
